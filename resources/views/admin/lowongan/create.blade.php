...
<div class="buat-lowongan-wrapper container">
    ...
    <!-- Layout 2 Kolom -->
    <div class="form-card">
        <a href="{{ route('admin.lowongan.index') }}" class="back-icon"><i class="fas fa-arrow-left"></i></a>
            ...
            <div class="form-columns">
                ...
                <div class="left-column">
                    ...
                    <div class="card-sub">
                        ...
                        <input type="text" name="mitra_nama" id="mitra_nama" required>

                        <!-- Mitra Deskripsi -->
                        <label for="mitra_deskripsi">Deskripsi Mitra:</label>
                        <textarea name="mitra_deskripsi" id="mitra_deskripsi" rows="4" required></textarea>
                    </div>
                ...
                <div class="right-column">
                    ...
                    <div class="card-sub">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="gaji_min" id="gaji_min" required placeholder="Contoh: 3,200,000" min="0">
                            </div>
                            <div class="col-md-6">
                                <label for="gaji_max">Gaji Maksimum (Rp):</label>
                                <input type="number" name="gaji_max" id="gaji_max" required placeholder="Contoh: 4,500,000" min="0">
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <!-- Card Link Pendaftaran -->
                    <div class="card-sub">
                        <h5 class="section-title">Link Pendaftaran</h5>
                        <label for="link_pendaftaran">Link Pendaftaran:</label>
                        <input type="url" name="link_pendaftaran" id="link_pendaftaran" required>
                    </div>

                    <!-- Card Logo Mitra -->
                    <div class="card-sub">
                        <h5 class="section-title">Logo Mitra</h5>
                        <label for="logo_mitra">Upload Logo Mitra:</label>
                        <input type="file" name="mitra_logo" id="mitra_logo" accept="image/*" required>
                    </div>
