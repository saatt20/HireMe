        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center bg-white p-0">
            <div class="p-0 w-100">
                ...
                <div class="p-4 mx-auto" style="width: 100%; max-width: 500px;">
                    ...
                    <p class="mb-4 fw-reguler text-center">Silahkan masuk dengan akun perusahaan anda</p>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-grid">
                         ...
                         <div class="text-center mt-3">
                            ...
                            <a href="{{ route('register.mitra') }}" class="text-decoration-none text-danger fw-bold">Registrasi Akun</a>
                        </div>
                    </form>
                </div>
